...
<div class="col-xs-6 col-md-offset-3" style="padding-top: 100px;position: relative">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">挂失卡片</h3>
        </div>
        <div class="panel-body">
            <form action="card_missing_do.html?cardNumber=<c:out value="${cardInfo.cardNumber}"></c:out>" method="post" id="createOrUpdateCardReq">
                <p>挂失卡片，用户不能消费充值，但是可以登陆系统</p>
                ...
                <input style="float: right" type="submit" value="挂失卡片" class="btn btn-success btn-sm"
                       class="text-left">
                <script>
