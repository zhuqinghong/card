...
<div class="col-xs-6 col-md-offset-3" style="padding-top: 100px;position: relative">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">激活卡片</h3>
        </div>
        <div class="panel-body">
            <form action="card_active_do.html?cardNumber=<c:out value="${cardInfo.cardNumber}"></c:out>" method="post" id="createOrUpdateCardReq">
                <p>激活卡片，用户可以正常使用卡片所有功能包括，登陆、消费、充值、账单查询</p>
                ...
                <input style="float: right" type="submit" value="确认激活" class="btn btn-success btn-sm"
                       class="text-left">
                <script>
