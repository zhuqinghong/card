...
<div class="col-xs-6 col-md-offset-3" style="padding-top: 100px;position: relative">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">删除卡片</h3>
        </div>
        <div class="panel-body">
            <form action="admin_card_delete_do.html?userId=<c:out value="${cardInfo.userId}"></c:out>" method="post" id="createOrUpdateCardReq">
                <p>删除卡片信息，同时会删除用户信息</p>
                ...
                <input style="float: right" type="submit" value="确认删除" class="btn btn-success btn-sm"
                       class="text-left">
                <script>
